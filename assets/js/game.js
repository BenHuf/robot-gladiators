...
var fight = function() {
    ...
    if (promptFight === 'fight' || promptFight === "FIGHT") {
        ...
        // Subtrafts the value of 'playerAttack' from the value of 'enemyHealth' and use that result to update the value in the 'enemyHealth' variable.
    ...
    // If player choses any other option
    else {
