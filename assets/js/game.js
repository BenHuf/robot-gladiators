...
var fight = function(enemyName) {
    while(playerHealth > 0 && enemyHealth > 0) {
        ...
        console.log(
            playerName + " attacked " + enemyName + " for " + damage + " HP. " + enemyName + " now has " + enemyHealth + " health remaining."
        );
        ...
        console.log(
            enemyName + " attacked " + playerName + " for " + damage + " HP. " + playerName + " now has " + playerHealth + " health remaining."
        );
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            // reset enemyHealth with a random number before starting new fight
